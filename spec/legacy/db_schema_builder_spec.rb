...
require 'legacy/db_schema_builder'
...
RSpec.describe DbSchemaBuilder do
  ...
  describe '#build_schema' do
    xit 'creates a hash of the table data with name and body attributes' do
  ...
  describe '#call' do
    xit 'returns an array of the whole tables schema' do
